...
// Route pour rechercher des utilisateurs par email
...
// Route pour vérifier l'existence de plusieurs utilisateurs
app.post("/api/users/check", authenticateToken, async (req, res) => {
    try {
